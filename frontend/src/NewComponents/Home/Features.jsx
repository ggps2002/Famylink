    ...
    <div className="container my-24">
      ...
      <div className="flex gap-6 flex-wrap mt-9">
        <div className="p-6  w-[25rem] rounded-[20px] shadow-soft">
          ...
          <p className="text-[#8A8E99] text-md Livvic-Medium mt-4">Easily manage payments and stay tax-compliant</p>
        </div>
           <div className="p-6  w-[25rem] rounded-[20px] shadow-soft">
          ...
          <p className="text-[#8A8E99] text-md Livvic-Medium mt-4">Ensure your caregivers meet safety and trust standards</p>
        </div>
           <div className="p-6  w-[25rem] rounded-[20px] shadow-soft">
          ...
          <p className="text-[#8A8E99] text-md Livvic-Medium mt-4">Create clear expectations with customizable contracts</p>
        </div>
      </div>
    </div>
  );

  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 2: return (
        <HireStep4
          formRef={jobFormRef || {}}
          subHead1={'What is the current swimming skill level of your child?'}
          data={step1Data}
          inputNot={true}
        />
      );
      ...
      case 3: return (
        <HireStep4
          formRef={jobFormRef || {}}
          inputNot={true}
          subHead1={'How often do you require swimming lessons?'}
          data={step2Data}
        />
      );
      ...
      case 5: return (
        <HireStep4
          formRef={jobFormRef || {}}
          inputNot={true}
          subHead1={'Do you prefer lessons at a specific location?'}
          data={step4Data}
        />
      );
      case 6:
      ...
      case 7: return (
        <HireStep4
          ...
          formRef={jobFormRef || {}}
          inputNot={true}
          subHead1={'What are your specific goals for swimming lessons?'}
          data={step6Data}
        />
      );
      case 8: return (
            ...
            >
              <div>
                <p className='mt-10 mb-1 text-xl Classico'>
                  Do you have any special requirements or <br className="max-lg:hidden" />preferences for the swim coach?
                </p>
                <Form.Item

  ...
  const step4Data = [
    {
      ...
      data: [{ name: 'Child-related only' }, { name: 'Child-related and general household tasks' }]
    },
    {
      heading: 'Cooking',
      data: [
    ...
    },
    {
      ...
      data: [{ name: 'Transporting children only' }, { name: 'Transporting children and running household errands' }]
    },
    {

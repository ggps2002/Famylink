...
export default function JobSeekers() {
  const step1 = [
    {
      title: "Step 1",
      description:
        "Sign up and create a detailed profile showcasing your experience, skills, and certifications.",
    ...
    },
    {
      title: "Step 2",
      description:
        "Explore a variety of job opportunities that match your preferences and availability.",
      head: "Browse Job Listings",
      img: st2,
    },
    {
      title: "Step 3",
      description:
        "Communicate directly with families to discuss job details and arrange interviews.",
    ...
    },
    {
      title: "Step 4",
      description:
        "Secure the job that fits your skills and schedule, and start making a difference.",
      head: "Get Hired",
      img: st4,
    },
  ];
  ...
  const faq = [
    ...
    },
    {
      ...
      answer:
        "You set your own hourly rate, and families can decide whether they’d like to move forward based on your listed pricing.",
    },
    {
      question: "How do I get more job offers?",
      answer:
        "Completing your profile with a detailed bio, experience, and references increases visibility. Upgrading to a premium profile can also boost your ranking in searches and provide unlimited messaging with families.",
    },
    {
      question: "What if I only want to work for a few hours a week?",
      answer:
        "You can set your availability based on your preferred schedule. Families looking for part-time or occasional help will be able to find your profile.",
    },
  ];
  return (
    <div className="pb-12  bg-gradient-to-b from-[#FFEE8C] to-[#fdf8ea]">
      <div className="padd-res">
        <Sec1
          pic={img4}
          head={"Find your ideal job with ease"}
          preHead={"Discover jobs that match your passion and skills"}
          btnText={"Browse Jobs"}
        />
        ...
        <div className="bg-white  mt-12 py-12 px-1">
          <JoinLink
            ...
            head4={"Resources and Support"}
            subHead1={"Easily find families in need of your services."}
            subHead2={"Choose from full-time, part-time, and occasional jobs."}
            subHead3={
              "Join a vibrant community of fellow caregivers for support and networking"
            }
            subHead4={
              "Tap into our dynamic resources to boost your skills and career, it's social, it's fun, and it's all here for you"
            }
            img1={j7}
            img2={j8}
            img3={j9}

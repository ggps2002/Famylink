...
import SavingsHighlightBox from "../subComponents/savingsHighlightBox";
...
export default function Families() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(176.8deg, rgba(158, 220, 225, 0.5) -44.67%, rgba(218, 244, 239, 0.4) 25.5%, #EFECE6 100%)",
      }}
    >
      <div className="padd-res">
        <Sec1
          pic={img}
          head={"Quality care for your family's unique needs"}
          preHead={"Find your perfect match"}
        />
        ...
        <div className="bg-white py-12">
          ...
          <div className="mt-6">
            <NannySharePreview
              head={"Providers Matched to Your Needs"}
              type={"service"}
            />
          </div>
          <MetricsSection head={""} family={true} />
        </div>
          ...
          <div>
            ...
            <div className="mx-8 ">
              ...
              <p className="text-lg my-6 line1-20">
                Connect with compatible families to share childcare costs across
                all service types. Our systematic approach to family matching
                creates successful long-term arrangements for nannies, tutors,
                coaches, and specialists. Share costs while maintaining quality
                care.
              </p>
              <NavLink
                to={"/nannShare"}
                onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
                className="text-base text-cyan-500 underline cursor-pointer transition-colors duration-300 hover:opacity-70"
              >
        ...
        <div className="bg-white px-12 py-12 mt-12 justify-center items-center text-center">
          <div>
            ...
            <p className="text-lg line1-20 mt-6 mx-auto add-width">
              Streamline your childcare arrangements with our additional
              services. Ensure peace of mind and ease with payroll management,
              comprehensive background checks, and customizable job contract
              templates.
            </p>
          </div>
          <div className="flex flex-wrap justify-center gap-12 my-24">
            <div className="text-center w-80">
              ...
              <p className="text-base">
                Simplify payment processes and tax filings for your caregivers.
              </p>
            </div>
            <div className="text-center w-80">
              ...
              <p className="text-base">
                Access thorough screening options to ensure the safety and
                reliability of your caregivers.
              </p>
            </div>
            <div className="text-center w-80">
              ...
              <p className="text-base">
                Utilize customizable templates to create clear, professional
                agreements with your caregivers.
              </p>
            </div>
          </div>
          <NavLink
          ...
          >
            <button
              ...
              className="py-1 px-6 text-base font-normal transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-700 ..."
            >
              Learn More
            </button>
          </NavLink>
        ...
        <div className="bg-white pt-6  flex flex-wrap justify-center text-center items-center mt-16">
          <div>
            <div>
              ...
              <p className="text-lg mt-6 mb-14 mx-auto home-sec3 line1-20">
        ...
        <div className="bg-white px-12 py-12 mt-12 justify-center items-center text-center">
          <FrequentAskQuestion
            faq={faq}
            head={"Families FAQ (Hiring a Caregiver)"}
          />
        </div>
      </div>
    </div>

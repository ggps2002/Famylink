...
export default function SportCoach() {
    ...
    const Register = async () => {
        ...
        if (textAreaValue && textAreaValue.length > 0) {
            updatedAddInfo.push({ key: 'sportCoach', value: ({ ...formData, specialReq: textAreaValue }) });
        }
        else {
    ...
    const handleNext = async () => {
        ...
        if (step == 9) {
            ...
            if (hasSpecialReq) {
                if (textAreaValue && textAreaValue.length > 0) {
                    dispatch(addOrUpdateAdditionalInfo({ key: 'sportCoach', value: ({ ...formData, specialReq: textAreaValue }) }));
                }
                else {
                    dispatch(addOrUpdateAdditionalInfo({ key: 'sportCoach', value: formData }))
                }
    ...
    const renderStepContent = () => {
        switch (step) {
            case 1: return (
                <HireStep4 formRef={hireStepFormRef} head={"Sports Coach"} data={step1Data} checkBox={true} subHead1={"Which sport do you want your child to learn or improve in?"} inputName={"Type here..."} textAreaHead={"Other Preferences"} />
            )
            case 2: return (
                <HireStep4 formRef={hireStepFormRef} head={"Sports Coach"} data={step2Data} checkBox={true} inputNot={true} subHead1={"What is the current skill level of your child?"} />
            )
            case 3: return (
                <HireStep4 formRef={hireStepFormRef} head={"Sports Coach"} data={step3Data} checkBox={true} inputNot={true} subHead1={"How often do you require coaching sessions?"} />
            )
            case 4: return (
                <HireStep4 formRef={hireStepFormRef} head={"Sports Coach"} data={step4Data} checkBox={true} subHead1={"How long do you want each coaching session to be?"} inputNot={true} />
            )
            case 5: return (
                <HireStep4 formRef={hireStepFormRef} head={"Sports Coach"} data={step5Data} checkBox={true} subHead1={"Do you prefer sessions at a specific location?"} inputNot={true} />
            )
            case 6: return (
                <HireStep4 formRef={hireStepFormRef} head={"Sports Coach"} data={step6Data} checkBox={true} subHead1={"What are your specific goals for the coaching sessions?"} inputNot={true} />
            )
            case 7: return (
                <HireStep4 formRef={hireStepFormRef} head={"Sports Coach"} data={step7Data} checkBox={true} subHead1={"Do you have a preference for the coach's style?"} inputNot={true} />
            )
            case 8: return (
                <HireStep3 head={"Sports Coach"} daysState={daysState} setDaysState={updateDaysState} subHead={"What days and times are you available for coaching sessions?"} />
            )
            case 9: return (
                <>
                    ...
                    <Form className='flex justify-center' form={form} name="validateOnly" autoComplete="off">
                        <div>
                            <p className='Classico text-xl mb-2 input-text line1-20'>Do you have any special requirements or preferences for the sport coach ?</p>
                            <Form.Item

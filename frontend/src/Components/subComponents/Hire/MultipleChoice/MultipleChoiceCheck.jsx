...
export default function MultiFormContainer({ formData, head, subHead, formRef, addInput }) {
        ...
        <Form form={form} initialValues={formValues}>
            ...
            {formData.map((v, i) => {
                ...
                return (
                    <div className="flex justify-center my-5" key={i}>
                        <div>
                            <p className="Classico text-xl mb-1 input-text line1-20">{v.heading}</p>

                            {/* Select All/Deselect All button */}


                            {v.data.map((j, h) => (
                                <div className='input-width bg-white rounded-3xl py-4 px-4 my-3'>
            ...
            })}
            {
                ...
                <div className="flex justify-center" style={{ marginTop: "-20px" }}>
                    <div>
                        <p className='Classico text-xl mb-1 input-text line1-20'>
                            {addInput.name}
                        </p>
                        <div className="flex justify-center">
                            <InputTextArea name={addInput.val ? addInput.val : toCamelCase(addInput.name)} placeholder={addInput.placeholder} />
                        </div>
